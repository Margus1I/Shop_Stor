...
mongoose.connect("mongodb+srv://shopStore:user123@cluster0.da1yf2z.mongodb.net/shop-store?retryWrites=true&w=majority&appName=Cluster0");

// Api creation
app.get("/", (req, res) => {
    res.send("Express App is rinning")
})
...
// create middlewear to fetch user
...
// create endpoint for get cart data
