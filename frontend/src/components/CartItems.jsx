...
const CartItems = () => {
    ...
    return (
        <section className='max_padd_contain pt-28'>
                    ...
                    {all_products.map((e) => {
                        if (cartItems[e.id] > 0) {
                            return <tr key={e.id} className='border-b border-slate-900/20 text-gray-20 p-6 medium-14 text-center'>
                                ...
                                <td>${e.new_price}</td>
                                <td className='w-1/6 h-16 bg-white'>{cartItems[e.id]}</td>
                ...
                <div className='flex flex-col gap-10'>
                    ...
                    <div>
                        <div className='flexBetween py-4'>
                            ...
                            <h4 className='to-gray-30 font-semibold'>${getTotalCartAmount()}</h4>
                        </div>
                        <hr />
                        <div className='flexBetween py-4'>
                            <h4 className='medium-16'>Shipping Free:</h4>
                            <h4 className='to-gray-30 font-semibold'>Free</h4>
                        </div>
                        <hr />
                        <div className='flexBetween py-4'>
