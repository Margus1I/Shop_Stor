  ...
  return (
    <section className='relative bg-hero bg-cover bg-center bg-no-repeat h-screen w-full'>
        <div className='max_padd_container relative top-32 xs:top-52'>
            <h1 className='h1 capitalize max-w-[37rem]'>Shop Store Hub Junction</h1>
            <p className='text-gray-50 regular-16 mt-6 max-w-[33rem]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam, velit. Nam tempore deserunt distinctio adipisci, eos facere officiis rem animi qui enim est voluptatibus? Ab veniam quaerat laudantium aut praesentium explicabo natus sapiente!</p>
