    ...
    <section className="max_padd_container flexCenter flex-col pt-32">
      <div className="max-w-[555px] h-[600px] bg-white m-auto px-14 py-10 rounded-md">
        ...
        <div className="flex flex-col gap-4 mt-7">
          ...
          <input name="email" value={formData.email} onChange={changeHandler} type="email" placeholder="Email Adress" className="h-14 w-full pl-5 bg-slate-900/5 outline-none rounded-xl " />
        ...
        {state === "Sign Up" ? <p className="text-black font-bold">Already have an acount? <span onClick={() => { setState("Login") }} className="text-secondary underline cursor-pointer">Login</span></p> : <p className="text-black font-bold">Haven't an account? <span onClick={() => { setState("Sign Up") }} className="text-secondary underline cursor-pointer">Registration</span></p>}
